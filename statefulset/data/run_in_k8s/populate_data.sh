...
a1_sim_std_v2_0_host="a1-interface-std-v2-0.a1-sim"
a1_sim_std_v2_0_port="8085"
a1_sim_std_v2_1_host="a1-interface-std-v2-1.a1-sim"
a1_sim_std_v2_1_port="8085"
httpx=http
...
echo "ric5 version:"
curl -skw %{http_code} $httpx://$a1_sim_std_v2_0_host:$a1_sim_std_v2_0_port/counter/interface
echo -e "\n"

echo "ric6 version:"
curl -skw %{http_code} $httpx://$a1_sim_std_v2_1_host:$a1_sim_std_v2_1_port/counter/interface
echo -e "\n"
...
echo "create policy type 2 to ric5:"
curl -skw %{http_code} $httpx://$a1_sim_std_v2_0_host:$a1_sim_std_v2_0_port/policytype?id=2 -X PUT -H Accept:application/json -H Content-Type:application/json -H X-Requested-With:XMLHttpRequest --data-binary @testdata/v2/policy_type.json
echo -e "\n"
...
curl -k -X PUT -sw %{http_code} -H accept:application/json -H Content-Type:application/json "$httpx://$policy_agent_host:$policy_agent_port/a1-policy/v2/services" --data-binary @testdata/v2/service.json
echo -e "\n"
...
echo "create policy aa8feaa88d944d919ef0e83f2172a5100 to ric5 with type 2 and service controlpanel via policy agent:"
curl -k -X PUT -sw %{http_code} -H accept:application/json -H Content-Type:application/json "$httpx://$policy_agent_host:$policy_agent_port/a1-policy/v2/policies" --data-binary @testdata/v2/policy_std_v2.json
echo -e "\n"
